...
export const Header = () => {
  return (
    <header className="fixed inset-x-0 top-0 z-50 h-16 border-b border-white/[0.06] bg-[rgba(10,10,12,0.72)] backdrop-blur-[16px]">
        ...
        <nav className="flex w-full items-center justify-between gap-3">
          <a href="#hero" className="flex min-w-0 items-center gap-2.5">
            <Image
              ...
              width={34}
              height={34}
              className="size-[34px] shrink-0 rounded-full border-[1.5px] border-brand object-cover"
            />
