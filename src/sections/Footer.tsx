    ...
    return (
        <footer className="relative -z-10 overflow-x-clip">
            ...
            <div className="container">
                <div className="flex flex-col items-start gap-8 border-t border-white/[0.06] py-8 text-sm md:flex-row md:items-center md:justify-between">
                    <div className="text-[13px] text-white/45">
                        © 2024 Marusi Matei Bruno. All rights reserved.
                    </div>
                    <nav className="flex flex-col items-start gap-6 md:flex-row md:items-center md:gap-8">
