  ...
  return (
    <div className="py-16 lg:py-24">
      <div className="container">
        <SectionHeader
          title="That Clients Say about me"
          eyebrow="Happy Clients"
          description="See how i transform concepts into angaing digital experiences"
        />
                ...
                hover:-rotate-3 transition duration-300"
                  >
                    <div className="flex gap-4 items-center ">
                      <div className="size-14 flex-shrink-0 overflow-hidden rounded-full bg-gray-700">
                        <Image
